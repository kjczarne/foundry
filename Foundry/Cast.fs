...
/// <summary>
/// This module represents the *casting* logic, i.e. 
/// it collects all the steps of the process into
...
module Cast =
    ...
    /// able to inject it into the `cast` funtion that converts
    ...
    /// to this type </param>
    /// </summary>
    let cast (parsingOutput : ParserRawOutput) =
